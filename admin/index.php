...
function modLink()
{
    ...
    echo '<h4>' . _MD_WEBLINKSCONF . '</h4>';
    echo "<table width='100%' border='0' cellspacing='1' class='outer'>" . "<tr class=\"odd\"><td>";
    $result = $xoopsDB->query('select cid, title, address, address2, city, state, zip, country, phone, fax, email, url, logourl, premium from ' . $xoopsDB->prefix('xdir_links') . " where lid=$lid") || $eh->show('0013');
    echo '<h4>' . _MD_MODLINK . '</h4><br>';
...
function modLinkS()
{
    ...
    $xoopsDB->query('update '
                    ...
                    . " set cid='$cid', title='$title', address='$address', address2='$address2', city='$city', state='$state', zip='$zip', country='$country', phone='$phone', fax='$fax', email='$email', url='$url', logourl='$logourl', status=2, date="
                    . time()
...
function approve()
{
    ...
    $query       = 'update '
                   . $xoopsDB->prefix('xdir_links')
                   . " set cid='$cid', title='$title', address='$address', address2='$address2', city='$city', state='$state', zip='$zip', country='$country', phone='$phone', fax='$fax', email='$email', url='$url', logourl='$logourl', premium='$premium', status=1, date="
                   . time()
                   . ' where lid='
                   . $lid
                   . '';
